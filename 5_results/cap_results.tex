...
Filling system correctly filled 78\% of the 1035 cases where have both templates and entities 
...
\begin{table}[h!]
    ...
    2                                 & ask\_one\_fact\_with\_filter                                                                                           & 6.30\%              & 20.44\%           & 44.20\%                                   & 59.38\%                                 & 77.89\%          \\ \hline
    3                                 & ask\_two\_facts                                                                                                        & 2.00\%              & 15.93\%           & 30.97\%                                   & 62.86\%                                 & 81.82\%          \\ \hline
    4                                 & count\_one\_fact\_object                                                                                               & 2.20\%              & 20.63\%           & 25.40\%                                   & 84.38\%                                 & 96.30\%          \\ \hline
    5                                 & count\_one\_fact\_subject                                                                                              & 3.20\%              & 9.34\%            & 9.89\%                                    & 94.44\%                                 & 100.0\%         \\ \hline
    6                                 & rank\_instance\_of\_type\_one\_fact                                                                                    & 1.40\%              & 11.54\%           & 32.05\%                                   & 40.0\%                                 & 90.0\%          \\ \hline
    7                                 & rank\_max\_instance\_of\_type\_two\_facts                                                                              & 1.20\%              & 0.00\%            & 7.35\%                                    & 20.0\%                                 & 0.0\%           \\ \hline
    8                                 & rank\_min\_instance\_of\_type\_two\_facts                                                                              & 1.20\%              & 8.57\%            & 14.29\%                                   & 80.0\%                                 & 75.0\%          \\ \hline
    9                                 & select\_object\_instance\_of\_type                                                                                     & 6.80\%              & 4.34\%            & 23.72\%                                   & 22.58\%                                 & 80.95\%          \\ \hline
    10                                & select\_object\_using\_one\_statement\_property                                                                        & 10.10\%             & 19.55\%           & 40.65\%                                   & 68.35\%                                 & 70.37\%          \\ \hline
    11                                & select\_one\_fact\_object                                                                                              & 1.40\%              & 7.69\%            & 7.69\%                                    & 100.0\%                                 & 100.0\%         \\ \hline
    ...
    14                                & \begin{tabular}[c]{@{}c@{}}select\_one\_qualifier\_value\_using\_one\\ \_statement\_property\end{tabular}              & 10.90\%             & 20.29\%           & 42.79\%                                   & 77.04\%                                 & 61.54\%          \\ \hline
    15                                & select\_subject\_instance\_of\_type                                                                                    & 7.30\%              & 5.42\%            & 25.00\%                                   & 26.42\%                                 & 82.14\%          \\ \hline
    16                                & select\_subject\_instance\_of\_type\_contains\_word                                                                    & 5.00\%              & 13.64\%           & 62.59\%                                   & 28.49\%                                 & 76.47\%          \\ \hline
    17                                & select\_subject\_instance\_of\_type\_starts\_with                                                                      & 4.90\%              & 14.04\%           & 62.46\%                                   & 29.21\%                                 & 76.92\%          \\ \hline
    18                                & select\_two\_answers                                                                                                   & 3.30\%              & 14.14\%           & 16.23\%                                   & 100.0\%                                 & 87.10\%          \\ \hline
    ...
    22                                & \begin{tabular}[c]{@{}c@{}}select\_two\_qualifier\_values\_using\_one\\ \_statement\_property\end{tabular}             & 3.00\%              & 8.67\%            & 26.59\%                                   & 54.35\%                                 & 60.0\%          \\ \hline
    \multicolumn{2}{|c|}{\textbf{Total}}                                                                                                                       & 100\%               & 13.96\%           & 31.39\%                                   & 57.12\%                                 & 78\%             \\ \hline
    \end{tabular}%
    }
...
entity, which would further explain the poor performance for those cases.  Lastly, other 
cases that require more than one entity (e.g. templates 1, 14), where the Entity Linking 
gets to recognize all entities in a good amount of cases.

In regards to the Slot Filling system performance, results from 
Table~\ref{table:queryGenerationCorrectCasesPerTemplate} reassure that when the input is 
...
process}, which also applies for templates that require more than one entity. The filling 
