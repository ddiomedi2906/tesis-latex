...
\begin{table}[h!]
    ...
    \multicolumn{2}{|c|}{Total}                                                                                                                           & 5772                                                & 100.00\%                                                                           & 34.67\%                                                                                                & 29.82\%                                                                                & 4.85\%                                  \\ \hline
    \end{tabular}%
    }
...
The number of correct cases for both slot filling methods is lower than the correctly labeled cases 
...
\begin{table}[h!]
    ...
    \multicolumn{2}{|c|}{\textbf{Total}}                                                                                                                  & 5772                                                & 100.00\%                                                                           & 13.96\%                                                                                                    & 3.27\%                                                                                 & 10.69\%                                 \\ \hline
    \end{tabular}%
    }
...
of Accuracy are displayed for each \LCQuADtwo{} base template. We can see that there are more cases than 
...
generation was similar for both our system and the baseline, with 65.32\% and 70.2\% incorrect 
cases respectively.
...
\begin{table}[h!]
    ...
    \hline
    \multicolumn{7}{|c|}{\textbf{Analysis per template for each module of the ElNeuQA system}}                                                                                                                                                                                                                    \\ \hline
    \multicolumn{1}{|c|}{\textbf{ID}} & \textbf{Template}                                                                                                      & \textbf{Dataset} & \textbf{Accuracy} & \multicolumn{1}{c|}{\textbf{Template}} & \multicolumn{1}{c|}{\textbf{Entity}} & \textbf{Slot} \\ \hline
    1                                 & ask\_one\_fact                                                                                                         & 1.90\%              & 36.61\%           & 51.79\%                                   & 84.48\%                                 & 83.67\%          \\ \hline
    2                                 & ask\_one\_fact\_with\_filter                                                                                           & 6.30\%              & 20.44\%           & 45.03\%                                   & 59.38\%                                 & 77.89\%          \\ \hline
    3                                 & ask\_two\_facts                                                                                                        & 2.00\%              & 15.93\%           & 30.97\%                                   & 62.86\%                                 & 81.82\%          \\ \hline
    4                                 & count\_one\_fact\_object                                                                                               & 2.20\%              & 20.63\%           & 25.40\%                                   & 84.38\%                                 & 96.30\%          \\ \hline
    5                                 & count\_one\_fact\_subject                                                                                              & 3.20\%              & 9.34\%            & 9.89\%                                    & 94.44\%                                 & 100.00\%         \\ \hline
    6                                 & rank\_instance\_of\_type\_one\_fact                                                                                    & 1.40\%              & 11.54\%           & 32.05\%                                   & 40.00\%                                 & 90.00\%          \\ \hline
    7                                 & rank\_max\_instance\_of\_type\_two\_facts                                                                              & 1.20\%              & 0.00\%            & 7.35\%                                    & 20.00\%                                 & 0.00\%           \\ \hline
    8                                 & rank\_min\_instance\_of\_type\_two\_facts                                                                              & 1.20\%              & 8.57\%            & 14.29\%                                   & 80.00\%                                 & 75.00\%          \\ \hline
    9                                 & select\_object\_instance\_of\_type                                                                                     & 6.80\%              & 4.34\%            & 23.72\%                                   & 22.58\%                                 & 80.95\%          \\ \hline
    10                                & select\_object\_using\_one\_statement\_property                                                                        & 10.10\%             & 19.55\%           & 50.94\%                                   & 68.35\%                                 & 70.37\%          \\ \hline
    11                                & select\_one\_fact\_object                                                                                              & 1.40\%              & 7.69\%            & 7.69\%                                    & 100.00\%                                 & 100.00\%         \\ \hline
    12                                & select\_one\_fact\_subject                                                                                             & 5.00\%              & 3.82\%            & 5.90\%                                    & 76.47\%                                 & 84.62\%          \\ \hline
    13                                & \begin{tabular}[c]{@{}c@{}}select\_one\_qualifier\_value\_and\_object\_using\_one\\ \_statement\_property\end{tabular} & 2.40\%              & 47.06\%           & 52.94\%                                   & 90.28\%                                 & 98.46\%          \\ \hline
    14                                & \begin{tabular}[c]{@{}c@{}}select\_one\_qualifier\_value\_using\_one\\ \_statement\_property\end{tabular}              & 10.90\%             & 20.29\%           & 52.14\%                                   & 77.04\%                                 & 61.54\%          \\ \hline
    15                                & select\_subject\_instance\_of\_type                                                                                    & 7.30\%              & 5.42\%            & 25.00\%                                   & 26.42\%                                 & 82.14\%          \\ \hline
    16                                & select\_subject\_instance\_of\_type\_contains\_word                                                                    & 5.00\%              & 13.64\%           & 70.98\%                                   & 28.49\%                                 & 76.47\%          \\ \hline
    17                                & select\_subject\_instance\_of\_type\_starts\_with                                                                      & 4.90\%              & 14.04\%           & 77.54\%                                   & 29.21\%                                 & 76.92\%          \\ \hline
    18                                & select\_two\_answers                                                                                                   & 3.30\%              & 14.14\%           & 16.23\%                                   & 100.00\%                                 & 87.10\%          \\ \hline
    19                                & select\_two\_facts\_left\_subject                                                                                      & 6.80\%              & 8.91\%            & 13.23\%                                   & 69.23\%                                 & 97.22\%          \\ \hline
    20                                & select\_two\_facts\_right\_subject                                                                                     & 7.10\%              & 9.95\%            & 14.08\%                                   & 74.14\%                                 & 95.35\%          \\ \hline
    21                                & select\_two\_facts\_subject\_object                                                                                    & 6.70\%              & 14.14\%           & 31.88\%                                   & 52.42\%                                 & 84.62\%          \\ \hline
    22                                & \begin{tabular}[c]{@{}c@{}}select\_two\_qualifier\_values\_using\_one\\ \_statement\_property\end{tabular}             & 3.00\%              & 8.67\%            & 26.59\%                                   & 54.35\%                                 & 60.00\%          \\ \hline
    \multicolumn{2}{|c|}{\textbf{Total}}                                                                                                                       & 100.00\%               & 13.96\%           & 34.67\%                                   & 57.12\%                                 & 78.00\%             \\ \hline
    \end{tabular}%
    }
    \caption{ElNeuQA modules correct cases per template.}
    \label{table:queryGenerationCorrectCasesPerTemplate}
\end{table}

A more granular analysis per template is provided in Table~\ref{table:queryGenerationCorrectCasesPerTemplate}. 
The purpose is to understand how the Entity Linking and Slot Filling perform per template 
when the Query Template is correctly generated. We provide the \SPARQL{} Query accuracy 
from Table~\ref{table:queryGenerationComparison} and the percentage of correct Query 
Templates (Template), similar to what is shown in Table~\ref{table:queryTemplatePerTemplate}. 
In the case of the entities (Entity), we only include the cases with a correct Query 
Template (though the overall results per template do not vary much). For the slots (Slot), 
we only count the cases where the Query Template and entities are correctly identified
\footnote{We make this differentiation because we are only interested in illustrating the 
correctness of the Slot Filling system when the input (i.e. Query Template and entities) 
is well provided. We don't expect this module to perform correctly otherwise.}.

When the template requires one entity (e.g. templates 4, 5, 10, 11, 12, 13, 18) the Entity 
...
rank-type templates (i.e. templates 7 and 8) that require at least one \dquotes{instance of} 
...
We also evaluate the performance looking at the best 5 predictions per 
...
\begin{table}[]
    ...
    \multicolumn{2}{|c|}{\textbf{Total}}                                                                                                                  & 5772                                                & 100.00\%                                                                           & 26.90                                                                                                      & 16.40                                                                                  & 10.50                                                                              \\ \hline
    \end{tabular}%
    }
