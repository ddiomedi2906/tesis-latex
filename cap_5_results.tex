...
\begin{table}[h!]
    ...
    \hline
    \multirow{3}{*}{System} & \multicolumn{2}{c|}{LC-QuAD 2 (valid)}          & \multicolumn{2}{c|}{QALD-7}                     & \multicolumn{2}{c|}{WikiSPARQL}                 \\ \cline{2-7} 
                            & \multicolumn{2}{c|}{Size: 21,394}               & \multicolumn{2}{c|}{Size: 5,772}                & \multicolumn{2}{c|}{Size: 100}                  \\ \cline{2-7} 
                            & \multicolumn{1}{c|}{BLEU score} & Accuracy (\%) & \multicolumn{1}{c|}{BLEU score} & Accuracy (\%) & \multicolumn{1}{c|}{BLEU score} & Accuracy (\%) \\ \hline
...
\begin{table}[h!]
    ...
    1                            & ask\_one\_fact                                                                                                         & 112                                                 & 1.94\%                                                                          & 51.79\%                                                                                                & 17.86\%                                                                                & 33.93\%                                 \\
    ...
    12                           & select\_one\_fact\_subject                                                                                             & 288                                                 & 4.99\%                                                                          & 5.90\%                                                                                                 & 9.72\%                                                                                 & \textbf{-3.82\%}                        \\
    13                           & \begin{tabular}[c]{@{}c@{}}select\_one\_qualifier\_value\_and\_object\_using\\ \_one\_statement\_property\end{tabular} & 136                                                 & 2.36\%                                                                          & 52.94\%                                                                                                & 48.53\%                                                                                & 4.41\%                                  \\
    14                           & \begin{tabular}[c]{@{}c@{}}select\_one\_qualifier\_value\_using\_one\\ \_statement\_property\end{tabular}              & 631                                                 & 10.93\%                                                                         & 52.14\%                                                                                                & 39.78\%                                                                                & 12.36\%                                 \\
    15                           & select\_subject\_instance\_of\_type                                                                                    & 424                                                 & 7.35\%                                                                          & 25.00\%                                                                                                & 20.75\%                                                                                & 4.25\%                                  \\
    16                           & select\_subject\_instance\_of\_type\_contains\_word                                                                    & 286                                                 & 4.95\%                                                                          & 70.98\%                                                                                                & 61.19\%                                                                                & 9.79\%                                  \\
...
the LC-QuAD 2 dataset (more details on each base template can be found in 
...
\begin{table}[h!]
    ...
    \caption{Performance of the Individual Entity Linking systems over LC-QuAD 2 validation.}
...
Finally, we evaluate both IEL systems and EEL systems over the test datasets: QALD-7, and our 
...
\begin{table}[h!]
    ...
    \multirow{2}{*}{\textbf{Dataset}} & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Number \\ of cases\end{tabular}}} & \multicolumn{3}{c|}{\textbf{Micro}}                                                                         & \multicolumn{3}{c|}{\textbf{Macro}}                                                                         \\ \cline{3-8} 
                                      &                                                                                      & \multicolumn{1}{c|}{\textbf{Recall}} & \multicolumn{1}{c|}{\textbf{Precision}} & \textbf{F1-score} & \multicolumn{1}{c|}{\textbf{Recall}} & \multicolumn{1}{c|}{\textbf{Precision}} & \textbf{F1-score} \\ \hline
    LC-QuAD 2.0 (valid)               & 5772                                                                                 & 66.9                                 & 62.0                                    & 64.4              & 66.9                                 & 63.8                                    & 64.8              \\
...
\begin{table}[h!]
    ...
    \multirow{2}{*}{\textbf{Dataset}} & \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Number \\ of cases\end{tabular}}} & \multicolumn{3}{c|}{\textbf{Micro}}                                                                         & \multicolumn{3}{c|}{\textbf{Macro}}                                                                         \\ \cline{3-8} 
                                      &                                                                                      & \multicolumn{1}{c|}{\textbf{Recall}} & \multicolumn{1}{c|}{\textbf{Precision}} & \textbf{F1-score} & \multicolumn{1}{c|}{\textbf{Recall}} & \multicolumn{1}{c|}{\textbf{Precision}} & \textbf{F1-score} \\ \hline
    LC-QuAD 2.0 (valid)               & 5772                                                                                 & 0.0                                 & 0.0                                    & 0.0              & 0.0                                 & 0.8                                    & 0.0              \\
    QALD-7                            & 150                                                                                  & 0.0                                 & 0.0                                    & 0.0              & 0.0                                 & 0.4                                    & 0.0              \\
    WikiSPARQL                        & 100                                                                                  & 0.0                                 & 0.0                                    & 0.0              & 0.0                                 & 0.9                                    & 0.0              \\ \hline
    \end{tabular}%
    }
...
Table~\ref{table:queryGenerationTestResults}, our system is not capable of generalizing the 
results obtained from training over other types of datasets as the type of queries contained in 
