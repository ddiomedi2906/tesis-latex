...
\begin{abstract}
    {
        The goal of \textit{Question Answering over Knowledge Graphs} (QAKG) is to find answers for 
    natural language questions over a \textit{Knowledge Graph}. Recent Neural Semantic Parsing-based QAKG 
    ...
    rather propose a QAKG approach that delegates the processing of entities to \textit{Entity Linking} 
    ...
    promising improvement in the performance of the QAKG task in the context of Wikidata. The future work 
