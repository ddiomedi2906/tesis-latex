...
one random variable obtain from observing another one, is used to quantify the specificity weight 
...
can be transfered to other tasks in order to enhance other models' learning capabilities (as we 
