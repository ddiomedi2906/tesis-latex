...
to certain extend that \dquotes{red} is a color, because we identify a degree of semantic 
similarity when comparing its numeric values to other colors' embeddings), and such knowledge 
can be transfer to other tasks in order to enhance other models' learning capabilities (as we 
