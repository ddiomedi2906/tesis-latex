...
In this work three \textbf{types of placeholders} were chosen for three types of values: entities, 
numbers, and string values. The entity placeholder identifies entities from the Knowledge Graph 
resource (e.g. \texttt{wd:Q80871}). Each entity placeholder identifies two aspects of the entity: 
