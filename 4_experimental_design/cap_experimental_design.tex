...
\begin{enumerate}
    \item Question is null, empty or not applicable (marked as \dquotestt{NA}). 
...
first query triple will be replaced by a placeholder labeled as \dquotestt{sbj\_1}. For numerical 
or string values, the placeholder would be \dquotestt{num} or \dquotestt{str\_value}, respectively. 
